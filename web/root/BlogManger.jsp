    ...
    <div class="left" style="width: 30%;">
        <div class="menu" >
            <ul>
                ...
                <li id="manbl" style="float: left;width: 100%"><a href="#" onclick="manager()">博客管理</a></li>
                <li style="float: left;width: 100%"><a href="#" onclick="find()">博客查询</a></li>
                <li style="float: left;width: 100%"><a href="optips.jsp">标签管理</a></li>
                <li style="float: left;width: 100%"><a href="#">博客数据</a></li>   <%--功能开发暂留--%>
        ...
        <div class="find" id="find" style="display:none;width: 90%;height:20px;position: relative;left: 15%;margin-top: 5px;top:8px;">
            <form action="BlogManger.jsp" id="findform" method="post">
...
<script type="text/javascript">
    ...
    function del(num){
        window.location.href="../DelBlog?num="+num;
    }
    function Find() {
